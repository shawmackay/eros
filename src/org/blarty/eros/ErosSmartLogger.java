...
import org.blarty.eros.logging.ErosLoggerImpl;
...
public class ErosSmartLogger implements Serializable,ErosLogger {
        ...
        public void initialise(String name) throws RemoteException {
                ...
                debug = Boolean.getBoolean("org.blarty.eros.debug");
        ...
        public Object getLoggingHandler() throws Exception {
                if (isLoggingVersion()) {
                        ...
                        return new org.blarty.eros.logging.ErosHandlerImpl(this, this.appName, this.publishLevel);
                } else {
                        if (debug)
