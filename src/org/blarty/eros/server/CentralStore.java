...
//import org.blarty.eros.logging.JDBCHandler;
//import org.w3c.dom.*;
...
//     * from the system property <i>org.blarty.eros.store.xml</i>.
//     * @throws Exception Any problems loading or reading the connection data.
//     */
//    private void loadConnectionInfo() throws Exception {
//        if( connectionInfo == null) {
//            connectionInfo = new File(System.getProperty("org.blarty.eros.store.xml"));        
...
//     * The data is expected in an XML file format whose location is obtained 
//     * from the system property <i>org.blarty.eros.transform.xml</i>.
//     * @throws Exception Any problems loading or reading the transform data.
//     */
//    private void loadTransformInfo() throws Exception {
//        if( transformInfo == null ) {
//            transformInfo = new File(System.getProperty("org.blarty.eros.transform.xml"));
...
//        return  "URL : " + this.url + "\n" +
//                "User : " + this.user + "\n" +
//                "Config : " + System.getProperty("org.blarty.eros.store.xml");
//    }
//
//    public static void main(String[] args) throws Exception {
//        CentralStore cs = null;
//        try {
//            System.setProperty("org.blarty.eros.transform.xml",
//                                    "d:\\jbproject\\eros2\\ErrorTable2.xsl");
//            System.setProperty("org.blarty.eros.store.xml",
//                                    "d:\\jbproject\\eros2\\src\\conninfo_development.xml");
//
//            cs = new CentralStore();
//            System.out.println(cs.toString());
//
//            org.blarty.eros.LoggingDetail ld = new org.blarty.eros.LoggingDetail();
...
//            ld.setLevel(org.blarty.eros.LogLevel.INFO);
...
//    }
//
//	/* @see org.blarty.eros.server.ErosBackendStore#initialise(java.util.logging.Logger, java.util.Map)
//	 */
